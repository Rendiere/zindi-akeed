...
activate zindi-akeed-recommendation
```
...
# Project organization
    ...
    ├── data
    │   ├── modelling      <- Datasets used directly for modelling.
    │   ├── processed      <- The interim, processed data sets that get combined for modelling.
